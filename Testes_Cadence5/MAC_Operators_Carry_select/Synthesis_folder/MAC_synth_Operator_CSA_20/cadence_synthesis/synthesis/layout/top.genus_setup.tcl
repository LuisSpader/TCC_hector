...
if {$_cell_area_ != "42502"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 42502,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "16692"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 16692,  current net area: $_net_area_"
}
unset _net_area_
