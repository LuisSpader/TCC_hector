...
if {$_cell_area_ != "1099"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 1099,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "892"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 892,  current net area: $_net_area_"
}
unset _net_area_
