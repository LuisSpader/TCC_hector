...
if {$_cell_area_ != "26948"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 26948,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "9423"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 9423,  current net area: $_net_area_"
}
unset _net_area_
