...
if {$_cell_area_ != "20050"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 20050,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "7188"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 7188,  current net area: $_net_area_"
}
unset _net_area_
