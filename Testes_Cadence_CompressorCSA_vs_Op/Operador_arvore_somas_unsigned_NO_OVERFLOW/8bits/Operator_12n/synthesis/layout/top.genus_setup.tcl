...
if {$_cell_area_ != "15730"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 15730,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "5418"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 5418,  current net area: $_net_area_"
}
unset _net_area_
