...
if {$_cell_area_ != "9991"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 9991,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "3510"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 3510,  current net area: $_net_area_"
}
unset _net_area_
