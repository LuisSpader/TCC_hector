...
if {$_cell_area_ != "21510"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 21510,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "7316"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 7316,  current net area: $_net_area_"
}
unset _net_area_
