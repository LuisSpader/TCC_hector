...
if {$_cell_area_ != "26929"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 26929,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "9136"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 9136,  current net area: $_net_area_"
}
unset _net_area_
