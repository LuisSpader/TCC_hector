...
if {$_cell_area_ != "19704"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 19704,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "6763"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 6763,  current net area: $_net_area_"
}
unset _net_area_
