...
if {$_cell_area_ != "34110"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 34110,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "11528"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 11528,  current net area: $_net_area_"
}
unset _net_area_
