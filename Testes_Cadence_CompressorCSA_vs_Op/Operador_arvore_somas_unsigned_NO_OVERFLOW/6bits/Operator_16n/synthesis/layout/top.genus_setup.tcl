...
if {$_cell_area_ != "16091"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 16091,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "5497"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 5497,  current net area: $_net_area_"
}
unset _net_area_
