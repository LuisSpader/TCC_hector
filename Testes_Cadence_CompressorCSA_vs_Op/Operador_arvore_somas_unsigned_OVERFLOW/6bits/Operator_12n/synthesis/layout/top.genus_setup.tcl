...
if {$_cell_area_ != "10661"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 10661,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "3905"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 3905,  current net area: $_net_area_"
}
unset _net_area_
