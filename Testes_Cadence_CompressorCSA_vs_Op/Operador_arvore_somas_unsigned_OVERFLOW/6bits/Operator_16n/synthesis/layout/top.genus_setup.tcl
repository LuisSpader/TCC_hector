...
if {$_cell_area_ != "14533"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 14533,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "5279"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 5279,  current net area: $_net_area_"
}
unset _net_area_
