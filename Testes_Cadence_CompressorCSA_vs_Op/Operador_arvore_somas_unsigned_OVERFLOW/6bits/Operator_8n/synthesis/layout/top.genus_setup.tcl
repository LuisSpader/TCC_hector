...
if {$_cell_area_ != "6838"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 6838,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "2560"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 2560,  current net area: $_net_area_"
}
unset _net_area_
