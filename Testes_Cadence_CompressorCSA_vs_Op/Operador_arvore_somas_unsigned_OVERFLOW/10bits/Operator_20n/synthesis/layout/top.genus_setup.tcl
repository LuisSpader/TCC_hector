...
if {$_cell_area_ != "32036"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 32036,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "11183"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 11183,  current net area: $_net_area_"
}
unset _net_area_
