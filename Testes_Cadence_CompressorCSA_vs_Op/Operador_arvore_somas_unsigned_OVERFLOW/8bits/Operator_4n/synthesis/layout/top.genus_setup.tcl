...
if {$_cell_area_ != "4049"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 4049,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "1582"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 1582,  current net area: $_net_area_"
}
unset _net_area_
