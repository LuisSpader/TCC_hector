...
if {$_cell_area_ != "14635"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 14635,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "5250"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 5250,  current net area: $_net_area_"
}
unset _net_area_
