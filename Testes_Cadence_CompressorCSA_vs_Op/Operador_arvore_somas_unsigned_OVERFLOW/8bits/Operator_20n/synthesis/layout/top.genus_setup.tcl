...
if {$_cell_area_ != "25172"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 25172,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "8889"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 8889,  current net area: $_net_area_"
}
unset _net_area_
