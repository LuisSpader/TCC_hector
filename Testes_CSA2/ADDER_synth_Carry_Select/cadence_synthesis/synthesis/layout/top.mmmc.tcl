#################################################################################
#
# Created by Genus(TM) Synthesis Solution 21.17-s066_1 on Thu Oct 05 17:16:06 -03 2023
#
#################################################################################

## library_sets
create_library_set -name default_emulate_libset_max \
    -timing { /usr/eda/dk/ibm/cmrf7sf/digital_20111130/synopsys/nom//PnomV180T025_STD_CELL_7RF.lib }
...
create_constraint_mode -name default_emulate_constraint_mode \
    -sdc_files { layout/top.default_emulate_constraint_mode.sdc }
