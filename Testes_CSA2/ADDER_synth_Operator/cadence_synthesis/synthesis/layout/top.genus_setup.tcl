...
if {$_cell_area_ != "1366"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 1366,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "642"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 642,  current net area: $_net_area_"
}
unset _net_area_
